...
public class Figure4_new_queueFiles {
	...
	public static void run() throws FileNotFoundException {
		...
		String queueFileName = "D:/Users/z3384108/Desktop/katana/queue_f4.txt";
		...
		for (double rightEnd = minimumRightEnd; rightEnd <= maximumRightEnd; rightEnd += rightGap) {
			...
			for (double leftEnd = minimumLeftEnd; leftEnd <= maximumLeftEnd; leftEnd += leftGap) {
				...
				String queue = "qsub f4_" + (int) leftEnd + "_" + (int) rightEnd + ".pbs";
				
				pbsFileName = "D:/Users/z3384108/Desktop/katana/f4_" + (int) leftEnd + "_" + 
						(int) rightEnd + ".pbs";
