...
public class Table2_queueFiles {

	static String queueFileName = "D:/Users/z3384108/Desktop/katana/queue_table2.txt", 
	...
	public static void run() throws IOException {
		...
		for (int day = 0; day < totalDays; day++) {
			...
			queueWriter.println("qsub " + date + "_t2.pbs");

			pbsFile = 
					new File("D:/Users/z3384108/Desktop/katana/" + date + "_t2.pbs");
			txtFile = 
					new File("D:/Users/z3384108/Desktop/katana/" + date + "_t2.txt");
	...
	private static void writePbsFile(String date) {
		...
		pbsWriter.println("");
		pbsWriter.println("java -jar db.jar < " + date + "_t2.txt");

	}

	private static void writeTxtFile(String date) {
		txtWriter.println("getb " + date);
	}
