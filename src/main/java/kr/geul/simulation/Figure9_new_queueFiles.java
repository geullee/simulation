...
public class Figure9_new_queueFiles {
	...
	public static void run() throws FileNotFoundException {
		...
		String queueFileName = "D:/Users/z3384108/Desktop/katana/queue_f9.txt";
		...
		for (double rightEnd = minimumRightEnd; rightEnd <= maximumRightEnd; rightEnd += rightGap) {
			...
			for (double leftEnd = minimumLeftEnd; leftEnd <= maximumLeftEnd; leftEnd += leftGap) {
				...
				String queue = "qsub f9_" + (int) leftEnd + "_" + (int) rightEnd + ".pbs";
				
				pbsFileName = "D:/Users/z3384108/Desktop/katana/f9_" + (int) leftEnd + "_" + 
						(int) rightEnd + ".pbs";
