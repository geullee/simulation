...
public class Figure13_new_mergeFiles {

	final static double minimumHalfWidth = 5.0, maximumHalfWidth = 800.0, halfWidthGap = 5.0;
	
	public static void run() throws IOException {
	
		String resultFileName = "D:/Users/z3384108/Desktop/katana/_f13.csv";	
		...
		for (double halfWidth = minimumHalfWidth; halfWidth <= maximumHalfWidth; 
				...
				String originalFileName = 
						"D:/Users/z3384108/Desktop/katana/_f13_" + (int) halfWidth + ".csv";
